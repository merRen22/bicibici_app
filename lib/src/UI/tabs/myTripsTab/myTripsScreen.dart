...
class MyTripsScreenState extends State<MyTripsScreen> {
          ...
          children: <Widget>[
            Container(
              child: LinearPercentIndicator(
                ...
                center: Text(
                  totalPoints.toStringAsFixed(2) + "/300 puntos",
                          ...
                          text: TextSpan(
                              ...
                              children: [
                                TextSpan(
                                  ...
                                  style: TextStyles.largeGreenFatText(),
                                ),
                                  ...
                                  child: RichText(
                                    ...
                                    text: TextSpan(
                                        ...
                                        children: [
                                          TextSpan(
                                            text:
                                                "${(calculateCO2().toStringAsFixed(2))}",
                                            style:
                                                TextStyles.smallPurpleFatText(),
                                          ),
                                ...
                                child: RichText(
                                  ...
                                  text: TextSpan(
                                      ...
                                      children: [
                                        TextSpan(
                                          text:
                                              "${(calculateCost(totalDistance).toStringAsFixed(2))}",
                                          style:
                                              TextStyles.smallPurpleFatText(),
                                        ),
  ...
  Widget tripCard(Trip trip) {
    return GestureDetector(
      onTap: () {
        Navigator.push(
          context,
          MaterialPageRoute(builder: (context) => DialogTrip(viaje: trip)),
        );
      },
      child: Card(
          shape: RoundedRectangleBorder(
              ...
              Row(
                children: <Widget>[
                  Padding(
                    ...
                    child: Text(
                      "Fecha ${(trip.startDate.substring(0, trip.startDate.indexOf("|")))}",
                      style: TextStyles.smallPurpleFatText(),
                    ),
                  ),
                ],
              ...
              Row(
                ...
                children: <Widget>[
                  Padding(
                    padding: const EdgeInsets.fromLTRB(20, 8, 8, 8),
                    child: Text(
                      "${(calculateCO2byTrip(trip).toStringAsFixed(2))} gr",
  ...
  Future _obtenerViajesUsuario() async {
    ...
    await presenter.obtenerViajesUsuario(uuid).then((response) {
      ...
      totalPoints =
          double.parse((totalDistance / 10).round().toStringAsFixed(2)) +
              response.puntaje;
      setState(() {
            ...
            headerSliverBuilder:
              ...
              return <Widget>[
                SliverAppBar(
                  ...
                  title:
                      Text("Mi uso", style: TextStyles.mediumPurpleFatText()),
                )
              ];
            },
            body: _isDataLoading
  ...
  double getTotalDistance() {
    double total = 0.0;
    trips.forEach((trip) => total += calculateDistance(
        trip.originLatitude,
  ...
  double calculateCO2byTrip(Trip trip) {
    return 171.7 *
        calculateDistance(trip.originLatitude, trip.originLongitude,
